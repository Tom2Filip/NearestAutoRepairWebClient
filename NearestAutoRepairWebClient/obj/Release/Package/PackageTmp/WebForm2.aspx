...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>         
     ...
     <!-- www.codedigest.com/Articles/ASPNET/347_Pass_Values_from_CodeBehind_to_JavaScript_and_From_JavaScript_to_CodeBehind_in_ASPNet.aspx -->
        ...
        <!-- www.aspdotnet-suresh.com/2013/01/adding-multiple-markers-to-google-maps.html -->
     ...
     <script type="text/javascript">         
         ...
         function initialize() {
             ...
             $.each(obj, function (i, item) {
                document.write(item.Name + ", " + item.Url);
            });
           */
       ...
       ///////////////////
        ...
        <script type="text/javascript">
            ...
            function showPosition(position) {
                // Not used -> this is for markers on google maps -> create marker for use location (different color)
